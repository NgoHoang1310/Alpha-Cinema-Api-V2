...
public class MovieServiceImpl implements MovieService {
    ...
    public MovieResponse handleCreateMovie(MovieRequest payload) throws IOException {
        ...
        String imgName = firebaseStorageService.save(payload.getFile());
    ...
    @Override
    public MovieResponse handleUpdateMovie(Long id, MovieRequest payload) {
        Movie movie = movieRepository.findMovieById(id);
        Set<Category> categories = new HashSet<>();
...
//        movie.setThumbPath(payload.getThumbPath());
